...
public class AssumptionViolatedExceptionJr extends org.junit.internal.AssumptionViolatedException {
     ...
     */
    public <T> AssumptionViolatedExceptionJr(T actual, Matcher<T> matcher) {
     ...
     */
    public <T> AssumptionViolatedExceptionJr(String message, T expected, Matcher<T> matcher) {
     ...
     */
    public AssumptionViolatedExceptionJr(String message) {
        super(message);
    }
     ...
     */
    public AssumptionViolatedExceptionJr(String message, Throwable t) {
        super(message, t);
    }
}
